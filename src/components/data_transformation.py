...
class DataTransformation:
    ...
    def initiate_data_transformation(self,train_path,test_path):
        try:
            ...
            logging.info("Reading test and train data completed successfully")
            ...
            # Use only transform for test data
            input_feature_test_arr = preprocessor_obj.transform(input_feature_test_df)

            # Concatenating the target feature with the input feature
            # np.c_ concats the two arrays column wise
            train_arr = np.c_[
